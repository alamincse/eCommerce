		...
		<div class="col-lg-12">
			...
			<ul class="breadcrumb">
				<li><a href="{{ URL::route( 'dashboard' ) }}">{{ 'Dashboard' }}</a></li>
			  	<li><a href="{{ URL::route( 'bottom-slider' ) }}">Bottom Slider</a></li>
			...
			{{ Form::open( array('route' => 'add-bottom-image', 'files' => true) ) }}
				<div class="tabbable">
					<ul class="nav nav-tabs">
			    		...
			    		<li class="pull-right">
							...
							<a href="{{ URL::route('bottom-slider') }}"><span style="color:white;"><i class="fa fa-reply"></i></span></a></span>
			    		</li><!-- .pull-right  -->
			    	</ul><!--  .nav .nav-tabs -->
			    			...
			    			<div class="tab-pane active" id="tab1">
								<div class="form-group">
									...
									<div class="thumbnail" style="width: 100px;height: 100px;">
										<a href="">{{ HTML::image( 'assets/dist/img/adds.gif' ) }}</a>
										{{ Form::file( 'image' ) }}
									</div><!-- .input-group  -->
