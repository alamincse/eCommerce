	...
	<div class="main-content" id="wrapper">
		...
		<div class="col-lg-12">
			...
			@foreach( $services as $service )
				{{ Form::open( array('route' => array( 'update-customer', $service->id ), 'files' => true) ) }}
					<ul class="nav">
						<li><h4>Edit Customer Service Point.</h4></li>
						<li class="pull-right">
							...
							<a href="{{ URL::route('customer-service') }}"><span style="color:white;"><i class="fa fa-reply"></i></span></a></span>
			    		</li><!-- .pull-right  -->
					</ul><br>
